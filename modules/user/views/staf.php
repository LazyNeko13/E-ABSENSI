			...
			<div class="card mb-5 mb-xl-8">
				...
				<div class="card-header border-0 pt-5">
					<h3 class="card-title align-items-start flex-column">
						<span class="card-label fw-bolder fs-3 mb-1">Tabel Staf</span>
						<!-- <span class="text-muted mt-1 fw-bold fs-7">Over 500 orders</span> -->
					</h3>
						
					<div class="card-toolbar" style="flex-wrap: nowrap; width: 300px;">
						...
						<a data-bs-toggle="modal" href="#tambahstafModal" role="button" class="btn btn-sm btn-light-primary">
						...
						<table class="table align-middle gs-0 gy-4">
							...
							<thead>
								<tr class="fw-bolder text-muted bg-light">
									...
									<th class="min-w-100px text-start">NIP</th>
									<th class="min-w-100px text-start">Nama Staf</th>
									<th class="min-w-100px text-start">Email</th>
									<th class="min-w-100px text-start">Role</th>
							...
							<tbody>
								<tr>
									...
									<td>
										<p  class="text-dark fw-bold d-block mb-1 fs-6">12345678910</p>
									</td>
									<td>
										<p class="text-dark fw-bold d-block mb-1 fs-6">Drs. Suhardi</p>
									</td>
									<td>
										<p class="text-dark fw-bold d-block mb-1 fs-6">suhardi1779@gmail.com</p>
									</td>
									<td>
										<p class="text-dark fw-bold d-block mb-1 fs-6">Pengajar</p>
									</td>
									<!-- <td>
										<img src="<?= base_url('assets/img/qr-code.png') ?>" class="img-thumbnail" alt="..." width="50">
									</td> -->
...
<!-- Tambah Siswa Modal -->
<div class="modal fade" id="tambahstafModal" aria-hidden="true" aria-labelledby="tambahsiswaModalLabel" tabindex="-1">
      ...
      <form class="form" action="#" id="kt_modal_add_event_form">
			...
			<div class="modal-body py-10 px-lg-17">
				<div class="fv-row mb-9">
					<label class="fs-6 fw-bold required mb-2">NIP</label>
					<input type="text" class="form-control form-control-solid" placeholder="Isikan NISN"/>
				</div>
				<div class="fv-row mb-9">
					<label class="fs-6 fw-bold required mb-2">Nama Staf</label>
				...
				<div class="fv-row mb-9">
					...
					<input type="text" class="form-control form-control-solid" value="suhardi1779@gmail.com" readonly />
				</div>
