			...
			<div class="card mb-5 mb-xl-8">
				...
				<div class="card-header border-0 pt-5">
					<h3 class="card-title align-items-start flex-column">
						<span class="card-label fw-bolder fs-3 mb-1">Tabel Siswa</span>
						...
						<table class="table align-middle gs-0 gy-4">
							...
							<thead>
								<tr class="fw-bolder text-muted bg-light">
									...
									<th class="min-w-120px text-start">Email</th>
									<th class="ps-4 min-w-200px">QR COde</th>
									<!-- <th class="min-w-120px text-start">QR Code</th> -->
								...
								<?php if ($result): ?>
									<?php foreach ($result as $row): ?>
										<tr>
											...
											<td>
												<p  class="text-dark fw-bold d-block mb-1 fs-6"><?= $row->NIS_NIP ?></p>
											</td>
											<td>
												<p class="text-dark fw-bold d-block mb-1 fs-6"><?= $row->NAMA_USER ?></p>
											</td>
											<td>
												<p class="text-dark fw-bold d-block mb-1 fs-6">XII RPL A</p>
											</td>
											<td>
												<p class="text-dark fw-bold d-block mb-1 fs-6"><?= ifnull($row->EMAIL,' - '); ?></p>
											</td>
											<td>
												<div class="d-flex align-items-center">
													<div class="symbol symbol-70px me-3">
														<img src="<?= base_url('assets/img/qr-code.png') ?>" class="" alt="" />
													</div>
													<div class="d-flex justify-content-start flex-column">
														<span class="text-dark fw-bold mb-1 fs-6">QR Code</span>
														<button class="btn btn-sm btn-light-primary fw-bold text-hover-light text-muted d-block fs-7">Cetak QR Code</button>
													</div>
												</div>
											</td>
											<td class="text-center">
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-150px py-3" data-kt-menu="true">
													<div class="menu-item px-3">
														<a href="#" class="menu-link flex-stack px-3">Edit siswa
														<i class="bi bi-pencil ms-2 fs-5" data-bs-toggle="tooltip"></i></a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="#" class="menu-link flex-stack px-3">Hapus siswa
