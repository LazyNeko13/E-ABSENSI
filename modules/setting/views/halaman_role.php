				...
				<div class="flex-lg-row-fluid ms-lg-10">
					...
					<div class="card card-flush mb-6 mb-xl-9">
						...
						<div class="card-header pt-5">
							<!--begin::Card title-->
							<div class="card-title">
								<h2 class="d-flex align-items-center">Tabel Developer
							...
							<div class="card-toolbar">
								...
								<div class="d-flex align-items-center position-relative my-1" data-kt-view-roles-table-toolbar="base">
									...
									<!--end::Svg Icon-->
									<input type="text" data-kt-roles-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Cari Pengguna" />
								</div>
								<!--end::Search-->
								<!--begin::Group actions-->
									...
									<tr>
										...
										<td class="d-flex align-items-center">
											...
											<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
												<a href="#">
													<div class="symbol-label">
														<img src="<?= base_url() ?>assets/media/avatars/150-26.jpg" alt="Max Smith" class="w-100" />
													</div>
												</a>
											</div>
											<!--end::Avatar-->
									...
									<tr>
										...
										<td class="d-flex align-items-center">
											...
											<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
												<a href="#">
													<div class="symbol-label">
														<img src="<?= base_url() ?>assets/media/avatars/150-4.jpg" alt="Sean Bean" class="w-100" />
													</div>
												</a>
											</div>
											<!--end::Avatar-->
									...
									<tr>
										...
										<td class="d-flex align-items-center">
											...
											<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
												<a href="#">
													<div class="symbol-label">
														<img src="<?= base_url() ?>assets/media/avatars/150-15.jpg" alt="Brian Cox" class="w-100" />
													</div>
												</a>
											</div>
											<!--end::Avatar-->
									...
									<tr>
										...
										<td class="d-flex align-items-center">
											...
											<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
												<a href="#">
													<div class="symbol-label">
														<img src="<?= base_url() ?>assets/media/avatars/150-8.jpg" alt="Francis Mitcham" class="w-100" />
													</div>
												</a>
											</div>
											<!--end::Avatar-->
									...
									<tr>
										...
										<td class="d-flex align-items-center">
											...
											<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
												<a href="#">
													<div class="symbol-label">
														<img src="<?= base_url() ?>assets/media/avatars/150-6.jpg" alt="Dan Wilson" class="w-100" />
													</div>
												</a>
											</div>
											<!--end::Avatar-->
									...
									<tr>
										...
										<td class="d-flex align-items-center">
											...
											<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
												<a href="#">
													<div class="symbol-label">
														<img src="<?= base_url() ?>assets/media/avatars/150-7.jpg" alt="Ana Crown" class="w-100" />
													</div>
												</a>
											</div>
											<!--end::Avatar-->
									...
									<tr>
										...
										<td class="d-flex align-items-center">
											...
											<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
												<a href="#">
													<div class="symbol-label">
														<img src="<?= base_url() ?>assets/media/avatars/150-17.jpg" alt="John Miller" class="w-100" />
													</div>
												</a>
											</div>
											<!--end::Avatar-->
