			...
			<div class="card mb-5 mb-xl-8">
				...
				<div class="card-header border-0 pt-5">
					<h3 class="card-title align-items-start flex-column">
						<span class="card-label fw-bolder fs-3 mb-1">Tabel Jadwal</span>
						<!-- <span class="text-muted mt-1 fw-bold fs-7">Over 500 orders</span> -->
					</h3>
						
					<div class="card-toolbar" style="flex-wrap: nowrap; width: 550px;">
						...
						<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_610d480c9e86f">
							...
							<div class="px-7 py-5">
								<div class="mb-10">
									...
									<div>
										<select class="form-select form-select-solid" aria-label="Default select example" data-kt-select2="true" data-placeholder="Pilih tingkat" data-allow-clear="true">
											<option></option>
								...
								<div class="mb-10">
									...
									<div>
										<select class="form-select form-select-solid" aria-label="Default select example" data-kt-select2="true" data-placeholder="Pilih jurusan" data-allow-clear="true">
											<option></option>
						...
						<a data-bs-toggle="modal" href="#tambahkelasModal" role="button" class="btn btn-sm btn-light-primary me-3">
						...
						<table class="table align-middle gs-0 gy-4">
							...
							<thead>
								<tr class="fw-bolder text-muted bg-light">
									...
									<th class="min-w-100px text-start">Nama Kelas</th>
											...
											<td class="text-center">
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-150px py-3" data-kt-menu="true">
													<div class="menu-item px-3">
														<a href="#" class="menu-link flex-stack px-3">Edit kelas
														<i class="bi bi-pencil ms-2 fs-5" data-bs-toggle="tooltip"></i></a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="#" class="menu-link flex-stack px-3">Hapus kelas
...
<!-- Tambah Siswa Modal -->
<div class="modal fade" id="tambahkelasModal" aria-hidden="true" aria-labelledby="tambahsiswaModalLabel" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered mw-650px">
    <div class="modal-content">
      <form class="form" action="#" id="kt_modal_add_event_form">
			<div class="modal-header">
				<h2 class="fw-bolder" data-kt-calendar="title">Tambah Kelas </h2>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body py-10 px-lg-17">
				<div class="fv-row mb-9">
					<label class="fs-6 fw-bold required mb-2">Nama Kelas</label>
