			...
			<div class="card mb-5 mb-xl-8">
				...
				<div class="card-header border-0 pt-5">
					<h3 class="card-title align-items-start flex-column">
						<span class="card-label fw-bolder fs-3 mb-1">Tabel Pelajaran</span>
						<!-- <span class="text-muted mt-1 fw-bold fs-7">Over 500 orders</span> -->
					</h3>
						
					<div class="card-toolbar" style="flex-wrap: nowrap; width: 500px;">
						...
						<a data-bs-toggle="modal" href="#tambahpelajaranModal" role="button" class="btn btn-sm btn-light-primary me-3">
						...
						<table class="table align-middle gs-0 gy-4">
							...
							<thead>
								<tr class="fw-bolder text-muted bg-light">
									...
									<th class="min-w-100px text-start">Nama Pelajaran</th>
									<th class="min-w-125px text-start">List Guru</th>
							...
							<tbody>
										<tr>
											...
											<td class="w-500px">
												<!-- <p class="text-dark fw-bold d-block mb-1 fs-6"></p> -->
												<ol class="list-group list-group-numbered">
												  <li class="list-group-item border-0 my-1"><span class="mx-2">Drs. Suhardi</span></li>
												  <li class="list-group-item border-0 my-1"><span class="mx-2">Drs. wayandaru </span></li>
												  <li class="list-group-item border-0 my-1"><span class="mx-2">Drs. Gunawan </span> </li>
												</ol>
											</td>
											...
											<td class="text-center">
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
													<div class="menu-item px-3">
														<a href="#" class="menu-link flex-stack px-3">Edit pelajaran
														<i class="bi bi-pencil ms-2 fs-5" data-bs-toggle="tooltip"></i></a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="#" class="menu-link flex-stack px-3">Hapus pelajaran
										...
										<tr>
											...
											<td>
												<p  class="text-dark fw-bold d-block mb-1 fs-6">Ilmu Pengetahuan Alam</p>
											</td>
...
<!-- Tambah Siswa Modal -->
<div class="modal fade" id="tambahpelajaranModal" aria-hidden="true" aria-labelledby="tambahsiswaModalLabel" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered mw-650px">
    <div class="modal-content">
      <form class="form" action="#" id="kt_modal_add_event_form">
			<div class="modal-header">
				<h2 class="fw-bolder" data-kt-calendar="title">Tambah Pelajaran </h2>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body py-10 px-lg-17">
				<div class="fv-row mb-9">
					<label class="fs-6 fw-bold required mb-2">Nama Pelajaran</label>
					<input type="text" class="form-control form-control-solid" placeholder="Isikan nama pelajaran"/>
				</div>
				<div class="fv-row mb-9">
					<label class="fs-6 fw-bold required mb-2">Nama guru</label>
					<input type="text" class="form-control form-control-solid" placeholder="Isikan nama guru"/>
				</div>
				<!-- <div class="fv-row mb-9">
