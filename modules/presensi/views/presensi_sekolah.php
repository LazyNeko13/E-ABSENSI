			...
			<div class="card mb-5 mb-xl-8">
				...
				<div class="card-header border-0 pt-5">
					<h3 class="card-title align-items-start flex-column">
						<span class="card-label fw-bolder fs-3 mb-1">Tabel Presensi Sekolah</span>
						...
						<table class="table align-middle gs-0 gy-4">
							...
							<thead>
								<tr class="fw-bolder text-muted bg-light">
									...
									<th class="min-w-120px text-center">Jam Masuk</th>
							...
							<tbody>
								<tr>
									...
									<td class="text-center">
										<p class="text-dark fw-bold d-block mb-1 fs-6"><i class="bi bi-clock text-dark mx-2" style="font-size:1.3rem;"></i>07:00</p>
									</td>
									<td class="text-center">
								...
								<tr>
									...
									<td class="text-center">
										<p class="text-dark fw-bold d-block mb-1 fs-6"><i class="bi bi-clock text-dark mx-2" style="font-size:1.3rem;"></i>09:00</p>
									</td>
									<td class="text-center">
								...
								<tr>
									...
									<td class="text-center">
										<p class="text-dark fw-bold d-block mb-1 fs-6"><i class="bi bi-clock text-dark mx-2" style="font-size:1.3rem;"></i>-</p>
									</td>
									<td class="text-center">
